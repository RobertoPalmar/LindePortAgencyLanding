/** Datos no traducibles de los 5 puertos: nombre y foto. Los tags y detalles viven en messages/. */
export const portNames = ["Aruba", "Bonaire", "Curaçao", "Panama", "Venezuela"] as const;
