export const es = {
  ...
  contact: {
    ...
    form: {
      ...
      port: "PUERTO",
      eta: "ETA",
      message: "SERVICIOS REQUERIDOS",
      send: "ENVIAR SOLICITUD",
      sending: "ENVIANDO…",
      sent: "Solicitud registrada. Conecta este formulario a tu correo o CRM para recibirla.",
      error: "No pudimos registrar la solicitud. Revisa los datos e inténtalo de nuevo.",
      required: "Revisa los campos obligatorios: nombre, correo, buque, puerto y ETA.",
    },
  },
