...
export const en: Dictionary = {
  ...
  contact: {
    ...
    form: {
      ...
      send: "SEND REQUEST",
      sending: "SENDING…",
      sent: "Request captured. Connect this form to your inbox or CRM to receive it.",
      error: "We could not capture the request. Check the details and try again.",
      required: "Please review the required fields: name, email, vessel, port and ETA.",
    },
  },
